/**
 * 使用微信的tfjsPlugin的fileStorageIO时，会报错Error: readFile:fail permission denied
 * 对tfjs-wechat-plugin的fileIOStorage进行修改, 使用github上的fileStorageIO
 * 
 * 原文件: https://github.com//tensorflow/tfjs-wechat/blob/master/src/plugin/utils/file_storage.ts
 */
 ...
 */
function removeFile(fsm, filePath) {
 ...
 */
function readFile(fsm, filePath, encoding) {
    return new Promise((resolve, reject) => {
        fsm.readFile({
            filePath,
            encoding,
 ...
 */
function writeFile(fsm, filePath, data, encoding) {
    return new Promise((resolve, reject) => {
 ...
 */
export function fileStorageIO(prefix, fileManager) {
