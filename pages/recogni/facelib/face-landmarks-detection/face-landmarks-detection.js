 ...
 * a `tf.io.IOHandler` object.
 *  - `detectorModelUrl` similar to modelUrl.
 */

// 修改，增加detectorModelUrl
function load$1(config) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, maxContinuousChecks, _b, detectionConfidence, _c, maxFaces, _d, iouThreshold, _e, scoreThreshold, _f, shouldLoadIrisModel, modelUrl, irisModelUrl, models, faceMesh, detectorModelUrl;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    _a = config.maxContinuousChecks, maxContinuousChecks = _a === void 0 ? 5 : _a, _b = config.detectionConfidence, detectionConfidence = _b === void 0 ? 0.9 : _b, _c = config.maxFaces, maxFaces = _c === void 0 ? 10 : _c, _d = config.iouThreshold, iouThreshold = _d === void 0 ? 0.3 : _d, _e = config.scoreThreshold, scoreThreshold = _e === void 0 ? 0.75 : _e, _f = config.shouldLoadIrisModel, shouldLoadIrisModel = _f === void 0 ? true : _f, modelUrl = config.modelUrl, irisModelUrl = config.irisModelUrl, detectorModelUrl = config.detectorModelUrl;
                    if (!shouldLoadIrisModel) return [3 /*break*/, 2];
                    return [4 /*yield*/, Promise.all([
                        loadDetectorModel(maxFaces, iouThreshold, scoreThreshold, detectorModelUrl),
...
function loadDetectorModel(maxFaces, iouThreshold, scoreThreshold, modelUrl) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, blazeface.load({ maxFaces: maxFaces, iouThreshold: iouThreshold, scoreThreshold: scoreThreshold, modelUrl: modelUrl })];
        });
    });
}
function loadMeshModel(modelUrl) {
